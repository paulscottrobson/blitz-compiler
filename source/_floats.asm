...
ismain_common = 0
	...
	.include	"./modules/ifloat32/operators/multiply.asm"
	.include	"./modules/ifloat32/operators/normalise.asm"
	.include	"./modules/ifloat32/utilities/shortmultiply.asm"
	.include	"./modules/ifloat32/testing/testing.asm"
	.include	"./modules/ifloat32/utilities/utility.asm"
