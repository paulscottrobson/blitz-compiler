...
class Builder(object):
	...
	def createSourceClass(self):
		h = open("scripts/buildsource.py","w")
		h.write(";\n;\tThis file is automatically generated\n;\n")
		h.write("class BuildSource(object):\n")
		self.exportList(h,"getINCFiles",self.getINCFiles())
		self.exportList(h,"getASMFiles",self.getASMFiles())
		h.close()

	def exportList(self,h,methodName,fList):
		h.write("\tdef {0}(self):\n".format(methodName))
		h.write("\t\treturn [ {0} ]\n".format(",".join(['"'+x+'"' for x in fList])))
		
if __name__ == "__main__":
 	Builder().createFile()
 	Builder().createSourceClass()